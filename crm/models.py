...
class UserInfo(models.Model):
    ...
    openid = models.CharField(verbose_name="微信唯一id",max_length=64)
...
class Customer(models.Model):
    ...
    recv_date = models.DateField(verbose_name='接客日期',null=True,blank=True)
...
class CustomerDistribution(models.Model):
    '''客户分配表'''
    user = models.ForeignKey(to="UserInfo",verbose_name="客户顾问",related_name="cds",limit_choices_to={"depart_id":1001})
    customer = models.ForeignKey(to="Customer",verbose_name="客户",related_name="dealers")
    ctime = models.DateField(verbose_name="成单时间")
    status_choices=(
        (1,"正在跟进"),
        (2,"已成单"),
        (3,"3天未跟进"),
...
class SaleRank(models.Model):
    '''销售权重和数量'''
    user = models.ForeignKey(to="UserInfo",verbose_name="销售",limit_choices_to={"depart":1001})
